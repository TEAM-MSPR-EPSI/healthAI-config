...
INSERT INTO session_progress (session_progress_start, session_progress_end, sport_session_id, user_id, sport_program_id, program_session_rank) VALUES
-- User 1 (programme 2 = Prise de Masse Intermédiaire : 7,8,9,15 x4)
('2024-01-08', '2024-01-08', 7, 1, 2, 1),
('2024-01-10', '2024-01-10', 8, 1, 2, 2),
('2024-01-12', '2024-01-12', 9, 1, 2, 3),
('2024-01-15', '2024-01-15', 7, 1, 2, 5),
('2024-01-17', '2024-01-17', 8, 1, 2, 6),
('2024-01-19', '2024-01-19', 9, 1, 2, 7),
('2024-01-22', '2024-01-22', 7, 1, 2, 9),
('2024-01-24', '2024-01-24', 8, 1, 2, 10),
('2024-01-26', '2024-01-26', 9, 1, 2, 11),
('2024-01-29', '2024-01-29', 12, 1, 2, 13),
('2024-02-01', '2024-02-01', 8, 1, 2, 14),
('2024-02-05', '2024-02-05', 13, 1, 2, 15),
-- User 2 (programme 3 = Cardio Fat Burner : 5,10,6 x4)
('2024-01-09', '2024-01-09', 5, 2, 3, 1),
('2024-01-11', '2024-01-11', 10, 2, 3, 2),
('2024-01-13', '2024-01-13', 6, 2, 3, 3),
('2024-01-16', '2024-01-16', 5, 2, 3, 4),
('2024-01-20', '2024-01-20', 10, 2, 3, 5),
('2024-01-25', '2024-01-25', 6, 2, 3, 6),
('2024-02-02', '2024-02-02', 5, 2, 3, 7),
('2024-02-08', '2024-02-08', 10, 2, 3, 8),
-- User 3 (programme 1 = Débutant Total Body : 1,6,2 x4)
('2024-02-01', '2024-02-01', 1, 3, 1, 1),
('2024-02-06', '2024-02-06', 2, 3, 1, 3),
('2024-02-10', '2024-02-10', 1, 3, 1, 4),
-- User 5 (programme 8 = Force & Puissance : 3,4,15,11 x5)
('2024-01-05', '2024-01-05', 3, 5, 8, 1),
('2024-01-08', '2024-01-08', 4, 5, 8, 2),
('2024-01-12', '2024-01-12', 3, 5, 8, 4),
('2024-01-15', '2024-01-15', 4, 5, 8, 5),
('2024-01-19', '2024-01-19', 11, 5, 8, 6),
('2024-01-22', '2024-01-22', 3, 5, 8, 7),
('2024-01-26', '2024-01-26', 4, 5, 8, 8),
('2024-01-29', '2024-01-29', 11, 5, 8, 10),
('2024-02-02', '2024-02-02', 3, 5, 8, 11),
('2024-02-05', '2024-02-05', 4, 5, 8, 12),
-- User 7 (programme 7 = HIIT Warrior : 14,5,15,6 x4)
('2024-01-10', '2024-01-10', 14, 7, 7, 1),
('2024-01-13', '2024-01-13', 5, 7, 7, 2),
('2024-01-17', '2024-01-17', 15, 7, 7, 3),
('2024-01-20', '2024-01-20', 14, 7, 7, 4),
('2024-01-24', '2024-01-24', 5, 7, 7, 5),
('2024-01-27', '2024-01-27', 6, 7, 7, 6),
('2024-02-03', '2024-02-03', 14, 7, 7, 7),
-- User 11 (programme 1 = Débutant Total Body)
('2024-03-01', '2024-03-01', 1, 11, 1, 1),
('2024-03-04', '2024-03-04', 6, 11, 1, 2),
('2024-03-07', '2024-03-07', 2, 11, 1, 3),
('2024-03-11', '2024-03-11', 1, 11, 1, 4),
('2024-03-14', '2024-03-14', 6, 11, 1, 5),
-- User 23 (programme 1 = Débutant Total Body)
('2024-04-15', NULL, 1, 23, 1, 1),
-- User 7 suite
('2024-04-16', NULL, 5, 7, 7, 8),
-- User 13 (programme 8 = Force & Puissance)
('2024-01-03', '2024-01-03', 8, 13, 8, 2),
('2024-01-06', '2024-01-06', 9, 13, 8, 3),
('2024-01-10', '2024-01-10', 7, 13, 8, 1),
('2024-01-13', '2024-01-13', 8, 13, 8, 5),
('2024-01-17', '2024-01-17', 9, 13, 8, 6),
('2024-01-20', '2024-01-20', 12, 13, 8, 9),
('2024-01-24', '2024-01-24', 13, 13, 8, 11),
('2024-01-27', '2024-01-27', 7, 13, 8, 4),
-- User 16 (programme 2 = Prise de Masse Intermédiaire)
('2024-01-15', '2024-01-15', 7, 16, 2, 1),
('2024-01-18', '2024-01-18', 8, 16, 2, 2),
('2024-01-22', '2024-01-22', 9, 16, 2, 3),
('2024-01-25', '2024-01-25', 7, 16, 2, 5),
('2024-01-29', '2024-01-29', 8, 16, 2, 6),
-- User 20 (programme 7 = HIIT Warrior)
('2024-02-05', '2024-02-05', 14, 20, 7, 1),
('2024-02-08', '2024-02-08', 5, 20, 7, 2),
('2024-02-12', '2024-02-12', 15, 20, 7, 3),
('2024-02-15', '2024-02-15', 14, 20, 7, 4);
...
-- Resynchronisation des séquences après insertion manuelle des données
DO $$ BEGIN
  PERFORM setval(pg_get_serial_sequence('company', 'company_id'), (SELECT MAX(company_id) FROM company));
  PERFORM setval(pg_get_serial_sequence('subscription', 'subscription_id'), (SELECT MAX(subscription_id) FROM subscription));
  PERFORM setval(pg_get_serial_sequence('authorization_', 'authorization_id'), (SELECT MAX(authorization_id) FROM authorization_));
  PERFORM setval(pg_get_serial_sequence('sport_program', 'sport_program_id'), (SELECT MAX(sport_program_id) FROM sport_program));
  PERFORM setval(pg_get_serial_sequence('sport_session', 'sport_session_id'), (SELECT MAX(sport_session_id) FROM sport_session));
  PERFORM setval(pg_get_serial_sequence('sport_exercise', 'sport_exercise_id'), (SELECT MAX(sport_exercise_id) FROM sport_exercise));
  PERFORM setval(pg_get_serial_sequence('sport_equipment', 'sport_equipment_id'), (SELECT MAX(sport_equipment_id) FROM sport_equipment));
  PERFORM setval(pg_get_serial_sequence('user_', 'user_id'), (SELECT MAX(user_id) FROM user_));
  PERFORM setval(pg_get_serial_sequence('recipe', 'recipe_id'), (SELECT MAX(recipe_id) FROM recipe));
  PERFORM setval(pg_get_serial_sequence('ingredient', 'ingredient_id'), (SELECT MAX(ingredient_id) FROM ingredient));
  PERFORM setval(pg_get_serial_sequence('user_biometric', 'biometric_id'), (SELECT MAX(biometric_id) FROM user_biometric));
  PERFORM setval(pg_get_serial_sequence('session_progress', 'session_progress_id'), (SELECT MAX(session_progress_id) FROM session_progress));
  PERFORM setval(pg_get_serial_sequence('consume', 'consume_id'), (SELECT MAX(consume_id) FROM consume));
  PERFORM setval(pg_get_serial_sequence('user_subscription', 'user_subscription_id'), (SELECT MAX(user_subscription_id) FROM user_subscription));
END $$;
